...
//       }}
//     >
//       <div className="w-full max-w-2xl p-8 transition bg-[#f0f7fa]  duration-300 transform border rounded-lg ">
...
//                 <label htmlFor={id} className="flex items-center text-sm font-semibold text-gray-700">
...
//           <button
//             type="submit"
//             className="w-full px-4 py-3 text-lg font-semibold text-white transition-opacity duration-200 rounded-lg shadow-md bg-[rgb(0,0,0)] bg-gradient-to-r hover:opacity-90"
