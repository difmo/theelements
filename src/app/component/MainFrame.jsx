    ...
    <div className="relative w-full h-[350px] md:h-[850px]  mx-auto">
      ...
      <div className="absolute flex items-center justify-center w-full h-full md:hidden sm:px-16">
        ...
        <div className="absolute flex flex-col items-start justify-center w-full h-full px-10 my-5 sm:px-16 md:px-16">
          ...
          <div
            className={`w-full text-[16px] sm:text-[20px] md:text-[28px] lg:text-[36px] leading-[24px] sm:leading-[28px] md:leading-[36px] lg:leading-[50px] text-[#F3F4F6] font-medium capitalize transition-opacity duration-1000 ease-in-out ${fadeInText ? "opacity-100" : "opacity-0"
              } text-center sm:text-center`}
          >
      ...
      <div className="absolute flex flex-col items-center justify-center hidden w-full h-full md:block">
        ...
        <div className="absolute flex flex-col items-center justify-center w-full h-full px-4 sm:px-16 md:px-16">
          <div
            className={`w-full text-[24px] sm:text-[36px] md:text-[48px] lg:text-[60px] leading-[36px] sm:leading-[45px] md:leading-[55px] lg:leading-[66.48px] text-[#F3F4F6] font-quattrocento font-semibold capitalize transition-opacity duration-1000 ease-in-out ${fadeInText ? "opacity-100" : "opacity-0"
              }`}
          >
            {headerdata[currentIndex].heading}
          </div>
          <div
            className={`w-full text-[16px] sm:text-[16px] md:text-[18px] lg:text-[24px] leading-[24px] sm:leading-[28px] md:leading-[36px] lg:leading-[50px] text-[#F3F4F6] font-medium capitalize transition-opacity duration-1000 ease-in-out ${fadeInText ? "opacity-100" : "opacity-0"
              }`}
          >
            {headerdata[currentIndex].description}
          </div>
