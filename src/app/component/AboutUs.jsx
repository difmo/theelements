...
const AboutUs = () => {
  return (
    <div className="w-ful " id="aboutus"> 
      {/* Header Section */}
      ...
      <div className="max-w-6xl mx-auto px-8 flex flex-col md:flex-row items-center gap-8">
        ...
        <div className="md:w-1/2">
          ...
          <h1 className="text-xl text-secondary-600 font-bold mb-4 font-mulish">
          Your Partner in Healthcare Innovation
          </h1>
          <h1 className="text-md text-primary-900  mb-4 font-mulish">
          ...
          <p className="text-primary-900  mb-6  font-mulish">
