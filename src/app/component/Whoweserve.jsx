  ...
  return (
    <>
      ...
      <div className="relative w-full max-w-[1440px] mt-14 mx-auto px-4 sm:px-8 lg:px-16">
            ...
            {rows.map((row) => (
              <div
                ...
                className={`cursor-pointer text-base sm:text-lg ${
                  activeTab === row.title
                    ? "text-[#fff] px-4 py-2 bg-blue-600 rounded-full"
                    : "text-black py-2 border px-4 rounded-full border-black"
                }`}
        ...
        <div className="block sm:hidden">
          {rows
            ...
            .map((row, index) => (
              <div
                key={index}
                className="flex flex-col items-center justify-between w-full pb-5 mb-12 border-b-2 border-gray-300 sm:flex-row sm:items-start"
              >
                <div className="text-[24px] font-[Quattrocento] text-[#CF7B41] sm:w-[20%] w-full mb-4 sm:mb-0 hidden sm:block">
                  {row.title}
                </div>
                ...
                <div className="w-full sm:w-[50%] pr-5 sm:px-0">
                  <ul className="pl-0 space-y-2 list-none sm:pl-5">
        ...
        <div className="relative flex-wrap justify-between hidden space-x-8 sm:flex">
          {rows.map((row, index) => (
            <div
              key={index}
            ...
            >
              ...
              {/* List Section */}
              <div className="w-full px-5 sm:w-full sm:px-0">
