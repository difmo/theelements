...
const OurServices2 = () => {
  ...
  // Handle expandable menu on mobile
  const handleExpandTab = (tabIndex) => {
    setExpandedTab(expandedTab === tabIndex ? null : tabIndex); // Toggle expansion
  };
  ...
  return (
    <div className="flex flex-col items-center justify-between gap-10 p-8 lg:flex-row bg-gradient-to-r from-blue-100 via-white to-blue-50">
      ...
      <div className="relative hidden md:flex w-full p-8 bg-white rounded-[60px]">
            ...
            <div key={tabIndex} className="mb-4">
              ...
              >
                <div className="flex items-center space-x-4">
                  {leftContainerContent[tabIndex].icon}
                  <span
                    className={`text-lg font-semibold text-orange-500 md:flex ${
