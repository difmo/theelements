...
const WhyPartners = () => {
  ...
  return (
    <div className="relative px-2 w-full max-w-[1440px] mt-14 mx-auto py-8">
      ...
      <div
        className="grid justify-center grid-cols-1 gap-3 px-2 md:px-10 md:gap-8 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-2"
  ...
  <div
    ...
    style={{
      backgroundImage: window.innerWidth >= 468 ? `${card.backgroundImage}, linear-gradient(to right, rgba(0, 123, 255, 0.2), rgba(255, 255, 255, 0.2))` : 'none',
      backgroundSize: window.innerWidth >=400 ? '100% 110%' : 'none', // Gradient on top of the image
