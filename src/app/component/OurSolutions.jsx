...
const cardData = [
  {
    ...
    description: "Description of solution 1 that highlights its benefits and unique features. This solution is tailored to provide the best outcomes for your needs.",
    image: ourimage,
  },
  {
    title: "Health Equity Solutions",
    description: "Description of solution 2 that addresses health disparities and promotes equitable care for all.",
    image: ourimage,
  },
  {
    title: "Community Health Outreach",
    description: "Description of solution 3 aimed at improving community health and access to resources.",
    image: ourimage,
  },
];
        ...
        <div className="relative z-10 flex flex-col items-center px-4 sm:px-8 lg:px-16">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 w-full">
            ...
            {cardData.map((card, index) => (
              <div key={index} className="group relative w-full h-[540px] rounded-[60px] overflow-hidden flex flex-col items-center">
                {/* Card Image */}
                <div className="relative w-full h-full transition-shadow duration-300 group-hover:shadow-lg group-hover:shadow-black rounded-lg overflow-hidden">
                  <Image
                ...
                <div
                  className="absolute inset-0 flex flex-col items-start justify-end text-left pb-6 text-white px-6"
                  style={{
                    background: "radial-gradient(100% 100% at 0% 100%, #0C455E 30.5%, rgba(12, 69, 94, 0) 100%)"
                  }}
                >
                  {/* Card Title */}
                  <h3
